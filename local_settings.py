...
MY_CONSUMER_KEY = environ.get('549f5eaa-92cf-46dc-8c50-bc20e0935ea4')#Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = environ.get('3dYmKMwGHMJnP1J4yJgKxx6HWoV1GaynQKOBnKKujsfY3ptEBe')#Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = environ.get('1491082167375466496-Lf1jl6iL1k1fVNJvDmtMth8jEb4wkp')#Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = environ.get('4ncp0YCU9tCYaCvY9knzfzunpBozhNQBQKdXJKnMKgIYkFaMzc')#Your Access Token Secret set in Heroku config
...
TWITTER_SOURCE_ACCOUNTS = ["hotsaltlamp"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "botsaltlamp"  # The name of the account you're tweeting to.
